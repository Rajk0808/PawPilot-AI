...
class KeyWordExtractor:
    def __init__(self):
        ...
        #'''.split())
        #
        #self.full_body_scan_keywords = set('''
        #body condition body check physical exam appearance overall condition 
        #obese obesity overweight underweight emaciated thin skinny bony 
        #body condition score BCS fat score muscle tone muscle definition 
        #ribs visible rib visibility ribs palpable ribs prominent spine visible 
        #spine palpability spinal process vertebrae feeling prominent 
        #hip prominence hip visibility hip bone feeling hip structure 
        #waist waist definition waist tuck abdominal tuck tucked abdomen 
        #hanging abdomen pendulous abdomen sagging skin loose skin 
        #muscle loss muscle wasting atrophy muscle weakness muscular 
        #muscle definition muscle tone athletic build lean physique 
        #build frame size large small giant breed standard breed 
        #barrel chested potbellied paunch spare tire abdominal fat 
        #fat deposits fat distribution subcutaneous fat visible fat 
        #overall assessment overall health general condition 
        #ideal weight target weight healthy weight weight range 
        #growth stage life stage maturity development 
        #breed standard breed specific body shape 
        #'''.split())
